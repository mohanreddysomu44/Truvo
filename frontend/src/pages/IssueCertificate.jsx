...
export default function IssueCertificate() {
  ...
  if (result) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center text-black">
          <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <span className="text-3xl">✅</span>
          </div>
          <h2 className="text-2xl font-bold mb-2">Certificate Issued!</h2>
          <p className="mb-6">Minted as NFT on the blockchain</p>
          ...
          <div className="flex gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 bg-indigo-600 text-white py-2.5 rounded-lg font-medium hover:bg-indigo-700 transition text-center"
            >
              View Certificate PDF
            </a>
            <button
              onClick={() => setResult(null)}
              className="flex-1 bg-gray-100 text-black py-2.5 rounded-lg font-medium hover:bg-gray-200 transition"
            >
              Issue Another
            </button>
          </div>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 text-black">
      <div className="mb-6">
        ...
        <p className="mt-1">Issue a blockchain-verified certificate to a learner</p>
      </div>

      {/* MetaMask connection status */}
      {!isConnected ? (
        <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-4 flex items-center justify-between text-black">
          <div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 font-mono text-sm text-black"
              placeholder="0x70997970C51812dc3A010C7d01b50e0d17dc79C8"
              required
            />
          </div>
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Skill / Course Name</label>
            <input
              type="text"
              value={form.skillName}
              onChange={(e) => setForm({ ...form, skillName: e.target.value })}
